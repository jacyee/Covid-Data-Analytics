...
select top 10 * from [covid-data]..covid_vaccination$
...
from [covid-data]..covid_vaccination$ va
join [covid-data]..covid_death$ de
...
from [covid-data]..covid_death$ de
left join [covid-data]..covid_vaccination$ va
on va.location=de.location
and va.date = de.date
where de.continent is not null